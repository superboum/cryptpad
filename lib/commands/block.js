...
Block.writeLoginBlock = function (Env, safeKey, msg, _cb) {
    ...
    nThen(function (w) {
        ...
        BlockStore.write(Env, publicKey, buffer, function (err) { // XXX increment registered users
...
*/
Block.removeLoginBlock = function (Env, safeKey, msg, _cb) { // decrement registered users
    var cb = Util.once(Util.mkAsync(_cb));
