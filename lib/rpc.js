...
RPC.create = function (Env, cb) {
    ...
    var updateLimitDaily = function (daily) {
        Quota.updateCachedLimits(Env, daily, function (e) {
            if (e) {
    ...
    updateLimitDaily(true);
    Env.intervals.dailyLimitUpdate = setInterval(function () {
        updateLimitDaily(true);
    }, 24*3600*1000);
    Env.updateLimit = updateLimitDaily;
