...
RPC.create = function (Env, cb) {
    ...
    var instancePing = function () {
        Quota.dailyPing(Env, function (e) {
            if (e) {
    ...
    var dailyRoutine = function () {
        instancePing();
        updateLimit();
    };
    Quota.applyCustomLimits(Env);
    dailyRoutine();
    Env.intervals.dailyLimitUpdate = setInterval(dailyRoutine, 24*3600*1000);
    Env.updateLimit = updateLimit;
